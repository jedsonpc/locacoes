...
const APP_VERSION_LABEL = "v2.1.29-auto-20260715-1303";
...
function getAccessUrl() {
  ...
  url.searchParams.set("v", "2.1.29-auto-20260715-1303");
  return url.toString();
}
...
async function logout() {
  ...
  location.replace("login.html?v=2.1.29-auto-20260715-1303");
}
