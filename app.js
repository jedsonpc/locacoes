...
const APP_VERSION_LABEL = "v2.1.30-auto-20260715-1710";
...
function getAccessUrl() {
  ...
  url.searchParams.set("v", "2.1.30-auto-20260715-1710");
  return url.toString();
}
...
async function logout() {
  ...
  location.replace("login.html?v=2.1.30-auto-20260715-1710");
}
