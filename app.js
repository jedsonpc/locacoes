...
const APP_VERSION_LABEL = "v2.1.40-auto-20260716-1315";
...
function getAccessUrl() {
  ...
  url.searchParams.set("v", "2.1.40-auto-20260716-1315");
  return url.toString();
}
...
async function logout() {
  ...
  location.replace("login.html?v=2.1.40-auto-20260716-1315");
}
